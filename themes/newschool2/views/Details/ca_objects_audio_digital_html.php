<?php
	...
	# --- media
	$va_audios = $t_object->representationsWithMimeType(array("audio/mpeg", "audio/x-aiff", "audio/x-wav", "audio/mp4", "video/mp4", "video/quicktime"), array("checkAccess" => $this->getVar("access_values")));
...
?>
			...
			<div class="row">
				...
				<div class='col-sm-12 col-md-6 col-lg-6'>
					...
					{{{<h3>MLA Citation:</h3><i>^ca_objects.preferred_labels.name</i>. <ifdef code="ca_objects.pbcoreDate.pbcoreDates_value"><unit>^ca_objects.pbcoreDate.pbcoreDates_value</unit>. </ifdef><ifcount code="ca_collections" min="1" max="1"><unit>^ca_collections.hierarchy.preferred_labels.name</unit>. </ifcount><i>New School Archives and Special Collections Digital Archive</i>. Web. ^DATE}}}
